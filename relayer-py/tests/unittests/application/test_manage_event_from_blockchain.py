...
#     register_config
# ):
#     with patch('src.relayer.application.manage_event_from_blockchain.get_blockchain_config'), \
#          patch('src.relayer.application.manage_event_from_blockchain.get_register_config'):
